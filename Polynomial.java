...
public class Polynomial{
    ...
    public Polynomial(Polynomial p){
        ...
        for(int i = 0; i < p.coef.length; i++) coef[i] = p.coef[i];
        deg = p.degree();
    }
    ...
    public Polynomial plus(Polynomial b){
        Polynomial a = this;
        Polynomial c = new Polynomial(0.0, Math.max(a.deg, b.deg));
    ...
    public Polynomial times(Polynomial b){
        Polynomial a = this;
        Polynomial c = new Polynomial(0.0, a.deg + b.deg);
    ...
    public Polynomial[] div(Polynomial b){
        Polynomial q = new Polynomial(0.0, 0);
    ...
    public Polynomial compose(Polynomial b){
        Polynomial a = this;
        Polynomial c = new Polynomial(0.0, 0);
    ...
    public Polynomial differentiate(){
        if(deg == 0) return new Polynomial(0.0, 0);
        Polynomial deriv = new Polynomial(0.0, deg - 1);
        deriv.deg = deg - 1;
        for(int i = 0; i < deg; i++)
    ...
    public static void main(String[] args){
        ...
        Polynomial p2 = new Polynomial(2.0, 2);
        Polynomial p3 = new Polynomial(4.0, 0);
        Polynomial p4 = new Polynomial(0.0, 1);
        Polynomial p = p1.plus(p2).plus(p3).plus(p4);   // 4x^3 + 3x^2 + 1

        Polynomial q1 = new Polynomial(1.0, 1);
        Polynomial q2 = new Polynomial(3.0, 0);
